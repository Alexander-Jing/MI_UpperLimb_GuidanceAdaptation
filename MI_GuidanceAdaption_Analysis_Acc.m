% 运动想象基本参数设置
subject_name = 'Wzh_compare_online_simu';  % 被试姓名
foldername_Sessions = 'Wzh_compare_online_simu_20241126_195121770_SimuData';  % folder data
foldername_Engagements = 'Online_Engagements_Wzh_compare_online_simu';
% 定义起始和结束的trial数量
