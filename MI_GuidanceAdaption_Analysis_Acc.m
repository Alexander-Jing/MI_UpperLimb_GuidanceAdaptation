% 运动想象基本参数设置
subject_name = 'Wyx_0923_compare_online_simu';  % 被试姓名
foldername_Sessions = 'Wyx_0923_compare_online_simu_20241126_175437727_SimuData';  % folder data
foldername_Engagements = 'Online_Engagements_Wyx_0923_compare_online_simu';
% 定义起始和结束的trial数量
