% 运动想象基本参数设置
subject_name = 'Wmy_compare_online_simu';  % 被试姓名
foldername_Sessions = 'Wmy_compare_online_simu_20241126_204237553_SimuData';  % folder data
foldername_Engagements = 'Online_Engagements_Wmy_compare_online_simu';
% 定义起始和结束的trial数量
