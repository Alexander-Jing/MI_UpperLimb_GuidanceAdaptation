% 运动想象基本参数设置
subject_name = 'Lh_compare_online_simu';  % 被试姓名
foldername_Sessions = 'Lh_compare_online_simu_20241127_000112791_SimuData';  % folder data
foldername_Engagements = 'Online_Engagements_Lh_compare_online_simu';
% 定义起始和结束的trial数量
