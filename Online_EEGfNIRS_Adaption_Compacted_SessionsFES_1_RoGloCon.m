...
sub_offline_collection_folder = 'Qbt_compare_offline_20241003_163015645_data';  % 被试的离线采集数据
subject_name_offline =  'Qbt_compare_offline';  % 离线收集数据时候的被试名称
% session 大于1时候要改动的部分
% 注意，由于设备问题，建议在session_idx为4之前重启下matlab，防止出现后面的中断
session_idx = 9;  % session index数量，如果是1的话，会自动生成相关排布
foldername_Sessions = 'Qbt_compare_online_20241003_172117106_data';  % 当session大于1的时候，需要手工修正foldername_Sessions
