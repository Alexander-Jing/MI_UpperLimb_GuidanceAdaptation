...
sub_offline_collection_folder = 'Thy_compare_offline_20241005_194049105_data';  % 被试的离线采集数据
subject_name_offline =  'Thy_compare_offline';  % 离线收集数据时候的被试名称
% session 大于1时候要改动的部分
...
StimAmplitude_2 = 5;  % MI2 手部分的幅值设置（mA）
