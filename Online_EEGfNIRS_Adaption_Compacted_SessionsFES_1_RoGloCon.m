...
sub_offline_collection_folder = 'Nkc_compare_offline_20241019_165826890_data';  % 被试的离线采集数据
subject_name_offline =  'Nkc_compare_offline';  % 离线收集数据时候的被试名称
% session 大于1时候要改动的部分
...
% 电刺激强度设置
StimAmplitude_1 = 4;  % MI1 肩关节的电刺激幅值测试（mA）
