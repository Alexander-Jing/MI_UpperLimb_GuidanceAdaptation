...
% 运动想象基本参数设置
subject_name = 'Jyt_test_0506_onlineSelected';  % 被试姓名
sub_offline_collection_folder = 'Jyt_test_0422_offline_20240506_211503496_data';  % 被试的离线采集数据
