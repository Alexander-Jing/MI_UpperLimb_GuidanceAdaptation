...
% 运动想象基本参数设置
subject_name = 'Jyt_test_0601_online_6_sessions';  % 被试姓名
sub_offline_collection_folder = 'Jyt_test_0601_offline_20240601_213002613_data';  % 被试的离线采集数据
subject_name_offline =  'Jyt_test_0601_offline';  % 离线收集数据时候的被试名称
% session 大于1时候要改动的部分
foldername_Sessions = 'Jyt_test_0601_online_6_sessions_20240606_112742309_data';  % 当session大于1的时候，需要手工修正foldername_Sessions
